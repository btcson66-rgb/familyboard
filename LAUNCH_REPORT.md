...
| HTTPS certificate | PENDING | DNS health is valid, but GitHub still reported `peer_failed_verification`; the same custom domain was removed and immediately re-added through the Pages API on 2026-08-20 to restart provisioning |
...
- Backup tag: `backup/pre-v1.2.1`
- Local backup: `D:\Fable company\backups\familyboard-v1.2.1-source-20260820-123759.zip`
