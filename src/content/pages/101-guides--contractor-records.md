---
title: "Contractor Records for Home Repairs | Scope, Change Orders and Close-Out"
description: "Build contractor records that preserve the agreed scope, written changes, payment evidence, site observations and close-out without confusing a quote with completed work."
route: "/guides/contractor-records/"
primaryIntent: "organize contractor project records, written changes, payments and close-out evidence"
...
nextStep: "Use the Home Repair Change Order Log to reconcile written changes, then keep original approvals, invoices and close-out evidence in protected project storage."
related:
...
faq:
  - question: "Is the FamilyBoard change-order output a contract amendment or electronic signature?"
    answer: "No. It is a private household index and arithmetic summary. It cannot verify identity or authority, prove delivery, create a signature or determine legal effect. Preserve the original written document and follow the contract and local rules."
  - question: "Should a proposed change be added to the current project total?"
    answer: "Not as an accepted amount. Keep proposed or pending cost and time effects visible, but include only written-approved and completed changes in the accepted arithmetic total. That total still does not decide what is legally due."
  - question: "Can a change reduce cost or time?"
    answer: "Yes. Record increases, decreases and zero effects separately for money and days. A deletion may reduce price, and a substitution can affect time without changing price. Preserve the written basis for each figure."
  - question: "Does marking a change completed prove the work is safe, compliant or defect-free?"
    answer: "No. It only records the household's chosen close-out evidence. Permits, inspections, qualified assessments, contract terms and applicable law determine safety, compliance, acceptance and warranty consequences."
  - question: "Do I always need a lien waiver before final payment?"
    answer: "There is no universal answer. Lien rights, notices and waiver forms are jurisdiction-specific. Check the responsible local authority or legal adviser for the actual project, parties and deadlines instead of copying another region's rule. **Content version:** 2"
contentVersion: 2
---
