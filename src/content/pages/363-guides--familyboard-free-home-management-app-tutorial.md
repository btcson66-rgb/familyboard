---
title: "Free Home Management App Tutorial | Start with FamilyBoard"
description: "Start FamilyBoard in three safe steps: create a local household, add a real asset or task, and export a backup before building a larger home history."
route: "/guides/familyboard-free-home-management-app-tutorial/"
primaryIntent: "onboard a household to the free FamilyBoard app with a useful first record, a dashboard habit and a verified backup"
...
nextStep: "Open the free app, create one useful record and export your first local backup."
related:
...
faq:
  - question: "Do I need an account or email to start FamilyBoard?"
    answer: "No. The current app creates the household in the browser's local database without an account or sign-in."
  - question: "What should I enter first?"
    answer: "Add one real, low-risk asset or responsibility that the household can review this week, then check that it appears on the relevant tab."
  - question: "Is the free app a limited trial?"
    answer: "No paid tier currently locks the app's tabs. The practical limit is browser storage and the fact that each browser profile has its own local household."
  - question: "Who makes the backup?"
    answer: "You do. Export a JSON backup from Settings and test a restore; there is no hidden server copy behind the free local-first design."
contentVersion: 1
---
