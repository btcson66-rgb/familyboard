---
title: "FamilyBoard Task Completion Tutorial | Record the Action Without Overclaiming"
description: "Learn how FamilyBoard records task completion time, where completed tasks disappear from, and why a completed checkbox is not proof of an external outcome."
route: "/guides/familyboard-task-completion-tutorial/"
primaryIntent: "mark a FamilyBoard task complete while preserving the difference between a local action and an external result"
primaryKeyword: "FamilyBoard task completion"
cluster: "product"
pageType: "content"
indexable: false
depthVerified: true
...
nextStep: "Rewrite one broad task as a single observable action, complete it once, and create a separate follow-up for any outside response."
related: []
faq:
  - question: "What happens when I press Complete?"
    answer: "FamilyBoard writes a local completion timestamp and removes the task from open-task views; it does not contact an outside service."
  - question: "Does completion prove a repair or payment happened?"
    answer: "No. Record external attendance, payment or result separately with its controlling source."
  - question: "Can a completed task appear on the shared display?"
    answer: "No. The shared display lists open tasks; completed tasks should be preserved in the local task history instead."
  - question: "Should I complete a task after sending a message?"
    answer: "Only if the task itself was sending the message; keep the recipient’s response or unresolved outcome as a separate follow-up."
contentVersion: 1
---
