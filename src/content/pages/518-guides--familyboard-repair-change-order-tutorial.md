---
title: "FamilyBoard Repair Change Order Tutorial | Keep Scope and Cost Traceable"
description: "Learn how to use FamilyBoard’s repair change-order log to preserve the original scope, record requested changes, approvals, cost differences and open questions."
route: "/guides/familyboard-repair-change-order-tutorial/"
primaryIntent: "record repair scope changes, approval evidence and cost differences without rewriting the original agreement"
...
nextStep: "Freeze the baseline, add one dated scope change with its source and leave approval or disagreement visible until the controlling process answers."
related: []
faq:
  - question: "Does a change order prove that the household accepted a price?"
    answer: "No. It records the stated request and evidence; the signed or otherwise controlling agreement determines acceptance."
  - question: "Should I replace the original scope when the work changes?"
    answer: "No. Preserve the original and add a dated change so the sequence stays understandable."
  - question: "Is an approved change proof that the repair was necessary?"
    answer: "No. Need, safety and technical suitability require the appropriate professional and source."
  - question: "Can the log calculate a legally valid claim?"
    answer: "No. It organizes facts and follow-up; contract and local rules control disputes and remedies."
contentVersion: 1
---
