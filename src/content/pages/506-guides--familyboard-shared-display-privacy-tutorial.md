---
title: "FamilyBoard Shared Display Privacy Tutorial | Show Tasks, Hide Private Details"
description: "Learn what FamilyBoard’s shared display shows and hides, how to choose low-sensitivity titles, and why a display URL is not an access-control system."
route: "/guides/familyboard-shared-display-privacy-tutorial/"
primaryIntent: "configure and review FamilyBoard’s shared display without exposing private household records"
primaryKeyword: "FamilyBoard shared display privacy"
cluster: "product"
pageType: "content"
indexable: false
depthVerified: true
...
nextStep: "Read the display as a visitor would, rewrite one sensitive title, and keep its detailed context in the private record."
related: []
faq:
  - question: "Which records are hidden from the shared display?"
    answer: "Contact records, detailed notes and other private record types are not shown; task and event titles remain visible."
  - question: "Does the display anonymize a sensitive task title?"
    answer: "No. Titles and some task context remain visible, so write low-sensitivity titles before showing the screen publicly."
  - question: "Is the display safe on an unlocked tablet?"
    answer: "It reduces the fields shown but cannot secure the browser, prevent screenshots or control who can view the device."
  - question: "Does display mode replace a private handoff?"
    answer: "No. Detailed notes, contacts and controlled source pointers belong in private views and authorised handoff channels."
contentVersion: 1
---
