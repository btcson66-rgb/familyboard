---
title: "FamilyBoard Members Tutorial | Set Roles and Household Responsibilities"
description: "Learn how to add household members in FamilyBoard, assign one accountable owner to tasks and maintenance, archive old roles and keep sensitive identity details out of the local app."
route: "/guides/familyboard-household-members-responsibilities-tutorial/"
primaryIntent: "configure household members in FamilyBoard and assign accountable owners without turning a shared list into an identity or permission system"
...
nextStep: "Add only the people who need an ownership label, assign one overdue task, and ask the backup role to find its source and next checkpoint."
related:
...
faq:
  - question: "Does adding a member create an account or invite that person?"
    answer: "No. A member is a local household record used for labels and ownership. FamilyBoard does not send an invitation or create login credentials."
  - question: "Can one task have several owners?"
    answer: "The task record has one owner. Choose the person accountable for the next outcome and mention supporting roles in a safe note or separate handoff."
  - question: "Does a member name control what that person can see?"
    answer: "No. Members are not an access-control list. Anyone who can open the browser profile may be able to view its local records."
  - question: "What should I do when someone moves out?"
    answer: "Archive the old member after reviewing open responsibilities, then reassign or hand off each active task. Do not delete the history just to make the current list look tidy."
contentVersion: 1
---
