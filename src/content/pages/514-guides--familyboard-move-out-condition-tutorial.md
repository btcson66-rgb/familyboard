---
title: "FamilyBoard Move-Out Condition Tutorial | Record a Fair Walkthrough"
description: "Learn how to use FamilyBoard’s move-out condition generator to record observations, evidence references, keys, meters and follow-up without making legal or deposit claims."
route: "/guides/familyboard-move-out-condition-tutorial/"
primaryIntent: "create a factual move-out walkthrough record with rooms, keys, meters and unresolved actions"
...
nextStep: "Run one calm walkthrough, link each observation to its original evidence and assign every unresolved row before the official handover."
related: []
faq:
  - question: "Is the generated record a signed move-out inspection form?"
    answer: "No. It is a private unsigned working record. The lease, required form and local process determine what counts as an official inspection or agreement."
  - question: "Should I label a condition as tenant damage?"
    answer: "Record what was observed and link the starting evidence. Cause, responsibility, normal wear and permitted charges need the controlling agreement, evidence and qualified advice."
  - question: "Can I put a lockbox PIN in the keys table?"
    answer: "No. Record the item and return status, then point to the protected credential process without copying the PIN."
  - question: "Does the report calculate a deposit refund?"
    answer: "No. It organizes observations and next actions; deposit rules, deductions and deadlines vary by lease and jurisdiction."
contentVersion: 1
---
