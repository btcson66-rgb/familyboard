---
title: "FamilyBoard Meal Prep Tutorial | Plan Roles, Sources and Serving Follow-Up"
description: "Learn how to organise weekly meal-prep roles with FamilyBoard: start with two meal slots, link the right source, assign preparation and record what actually happened."
route: "/guides/familyboard-meal-prep-tutorial/"
primaryIntent: "learn to coordinate weekly meal preparation, shopping sources and serving follow-up without storing health or order data"
...
nextStep: "Pick two upcoming meal slots, create a safe source code and assign one preparation role plus a serving-result review date."
related:
...
faq:
  - question: "Does FamilyBoard create recipes or calculate nutrition?"
    answer: "No. It records household tasks and source pointers; use the current recipe, label or qualified source that applies."
  - question: "Should I paste a grocery order or allergy note into a shared row?"
    answer: "No. Keep orders, addresses, payment information and health details in their protected source."
  - question: "Does assigning a preparation role prove that food was served?"
    answer: "No. A plan, action and serving result are separate observations."
  - question: "Do I need a whole-month meal plan?"
    answer: "No. Start with two meal slots, test the handoff and expand only when the family can complete and review it."
contentVersion: 1
---
