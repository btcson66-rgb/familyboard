---
title: "FamilyBoard House-Sitter Instruction Tutorial | Prepare a Clear, Privacy-Safe Visit"
description: "Learn how to use FamilyBoard's House-Sitter Instruction Generator for a bounded visit: record routines, source pointers, access limits, exceptions and a return check without sharing secrets."
route: "/guides/familyboard-house-sitter-instruction-generator-tutorial/"
primaryIntent: "learn to prepare a time-bounded house-sitter instruction sheet with source pointers, boundaries and check-ins without exposing keys or promising care results"
...
nextStep: "Define one visit window, prepare minimum instructions and ask the sitter to acknowledge the safe source and escalation route before arrival."
related: []
faq:
  - question: "Does the instruction sheet give a sitter permission to enter every room or account?"
    answer: "No. It records the limits the household has explicitly authorised."
  - question: "Should I put an alarm code, key location or full address in the public app record?"
    answer: "No. Keep access secrets in the protected handoff channel."
  - question: "Does a completed check-in prove the home or pet is safe?"
    answer: "No. It records an observed message or result, not a safety certification."
  - question: "Can the generator replace veterinary, emergency or building instructions?"
    answer: "No. Use the current responsible professional or authority source."
contentVersion: 1
---
