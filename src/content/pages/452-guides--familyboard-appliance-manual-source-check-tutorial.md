---
title: "FamilyBoard Appliance Manual Source Check Tutorial | Match Model, Version and Source"
description: "Learn how to use FamilyBoard to check an appliance manual source by model, date and responsible provider while keeping serial numbers private and unresolved conflicts visible."
route: "/guides/familyboard-appliance-manual-source-check-tutorial/"
primaryIntent: "learn to match an appliance manual to the correct model and source version without treating a download as repair or safety permission"
...
nextStep: "Create one neutral appliance code, link the protected model evidence and record which current source was checked before the next maintenance conversation."
related: []
faq:
  - question: "Does the log tell me how to repair or install an appliance?"
    answer: "No. It records the source match; the manufacturer manual and qualified professional control those instructions."
  - question: "Should I enter a full serial number in a shared row?"
    answer: "No. Use a neutral asset code and keep the identifier in a protected record."
  - question: "Does downloading a PDF prove it is the current manual?"
    answer: "No. Record the model, source, version date and any unresolved conflict before relying on it."
  - question: "Can a manual confirm that a recalled appliance is safe to use?"
    answer: "No. Use the current recall notice, manufacturer and relevant authority for that decision."
contentVersion: 1
---
