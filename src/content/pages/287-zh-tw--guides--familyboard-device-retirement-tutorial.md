...
primaryIntent: "teach Taiwan households a safe, source-aware device retirement routine without claiming that an app can erase hardware"
...
nextStep: "先用免費裝置退役交接工具整理核點，再把清除與交接交給正確的裝置和負責來源。"
related: []
faq:
  - question: "清除前最重要的檢查是什麼？"
    answer: "先確認裝置身分、家庭需要保留的資料、可讀的受保護備份和負責的帳號來源，再依平台說明操作。"
