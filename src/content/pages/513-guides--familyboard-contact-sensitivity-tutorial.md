---
title: "FamilyBoard Contact Sensitivity Tutorial | Share the Role, Protect the Details"
description: "Learn how FamilyBoard contact records use the sensitive flag, what handoffs exclude, and how to keep a useful source pointer without copying private details."
route: "/guides/familyboard-contact-sensitivity-tutorial/"
primaryIntent: "store a useful FamilyBoard contact record while controlling sensitive fields in handoffs and household views"
primaryKeyword: "FamilyBoard contact sensitivity"
cluster: "product"
pageType: "content"
indexable: true
depthVerified: true
...
nextStep: "Give one contact a neutral role code, mark its sharing sensitivity, verify the current source and preview the smallest handoff that can actually work."
related: []
faq:
  - question: "What does marking a contact sensitive do?"
    answer: "It helps exclude the contact from shareable handoff summaries; anyone who can open the local browser may still read it."
  - question: "Does sensitive hide a contact from the FamilyBoard app owner?"
    answer: "No. It is a sharing boundary, not encryption or an access-control system."
  - question: "Can I put a full address or door code in contact notes?"
    answer: "No. Keep secrets and unnecessary identity details in the appropriate protected source and use a neutral pointer."
  - question: "Does a contact record prove the person is available now?"
    answer: "No. Verify role, consent, number and availability through the current source before relying on it."
contentVersion: 1
---
