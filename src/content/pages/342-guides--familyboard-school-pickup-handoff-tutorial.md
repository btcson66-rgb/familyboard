---
title: "FamilyBoard School Pickup Handoff Tutorial | Roles, Sources and Return Review"
description: "Learn how to organise a school pickup handoff with FamilyBoard: define the activity, protect student details, assign a primary and backup role and record an actual return-home observation."
route: "/guides/familyboard-school-pickup-handoff-tutorial/"
primaryIntent: "learn to coordinate a bounded school or after-school pickup handoff without exposing a child’s identity or treating a reminder as a confirmed arrival"
...
nextStep: "Create one neutral pickup code, link the school or after-care source and assign a primary, backup and return-review role."
related:
...
faq:
  - question: "Can FamilyBoard replace a school, after-care or transport attendance system?"
    answer: "No. It is a household handoff summary; the institution’s protected process controls attendance and release."
  - question: "Should a shared row include a child’s name, class, school address or pickup code?"
    answer: "No. Use a neutral pickup code and keep identifying or access details in the institution’s controlled channel."
  - question: "Does a calendar reminder prove that a child arrived home?"
    answer: "No. A responsible household role must record the actual handoff or return observation."
  - question: "Can a wearable, card or safety product guarantee a pickup outcome?"
    answer: "No. Recommendations are optional and cannot replace the institution’s release procedure."
contentVersion: 1
---
