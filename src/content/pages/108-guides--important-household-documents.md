---
title: "Important Household Documents Checklist | Sources, Copies and Replacement Paths"
description: "Build an important household documents checklist around real decisions, current issuers, protected originals, limited copies and replacement paths."
route: "/guides/important-household-documents/"
primaryIntent: "build a household-specific important-document list with current sources, protected copies and replacement routes"
...
nextStep: "Choose three household responsibilities that would stall if the usual coordinator were unavailable. Record the controlling source, protected original or limited-copy state and official replacement route for each, then move only safe pointers into the household document index."
related:
...
faq:
  - question: "What are the most important household documents to organize first?"
  ...
  - question: "Should I scan every identity and financial document into one folder?"
    answer: "No. A scan may be a useful protected copy, but one shared folder can create excess exposure and a single failure path. Keep only safe pointers in the routine index, separate audiences, protect copies appropriately and record the official replacement process."
  - question: "Does a copy prove that a document is current or acceptable?"
    answer: "No. It proves only what was captured. Confirm the current issuer or controlling source and the receiving institution's requirements. Replacement and acceptance rules can differ by document and jurisdiction."
  - question: "How is this different from the Household Document Index Generator?"
    answer: "The coverage review decides which record classes apply and links each to a current source, protected-copy state and replacement route. The index generator then organizes safe location pointers. A later retrieval drill tests whether an authorized person can follow those pointers."
  - question: "Can FamilyBoard decide retention periods or destroy old documents?"
    answer: "No. Retention depends on the document's real purpose, controlling law, agreement, policy, claim or professional guidance. FamilyBoard can schedule a human review but should not automatically delete or shred a record."
contentVersion: 2
---
