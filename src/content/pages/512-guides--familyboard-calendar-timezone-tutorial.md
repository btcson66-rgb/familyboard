---
title: "FamilyBoard Calendar Timezone Tutorial | Keep Event Dates Traceable"
description: "Learn how FamilyBoard calendar events use browser-local time, how to record a source timezone, and why a calendar entry is not an appointment confirmation."
route: "/guides/familyboard-calendar-timezone-tutorial/"
primaryIntent: "record FamilyBoard calendar events with clear local-time and source context when households cross devices, regions or dates"
...
nextStep: "Copy the source timezone, enter explicit local dates, label the event as a plan or observation, and create a separate follow-up for confirmation."
related: []
faq:
  - question: "Does FamilyBoard convert an event to the provider’s timezone?"
    answer: "No. The app uses the browser’s local date and time fields; preserve the source timezone and confirm the controlling schedule separately."
  - question: "Does creating an event reserve an appointment?"
    answer: "No. It records a household plan or observation; the provider’s acknowledgement is a separate result."
  - question: "What should I do when an event crosses midnight?"
    answer: "Enter an explicit start and end date, keep the source wording and review which local day the household should act."
  - question: "Will a phone and wall tablet stay synchronized?"
    answer: "No. Each browser stores its own local data unless the household deliberately transfers a reviewed backup."
contentVersion: 1
---
