---
title: "FamilyBoard Household Quiet Hours | Protect Rest Without Missing Important Tasks"
description: "Learn how to document FamilyBoard quiet hours, urgent exceptions and backup roles without exposing a family member’s complete routine."
route: "/guides/familyboard-household-quiet-hours-tutorial/"
primaryIntent: "plan household quiet hours and escalation boundaries without hiding urgent responsibilities or publishing personal routines"
...
nextStep: "Write one quiet-hours boundary, define one urgent exception and test the backup route with the smallest safe amount of information."
related: []
faq:
  - question: "Do quiet hours block every reminder?"
    answer: "No. They document a preference and an agreed urgent path; external channels still control delivery."
  - question: "Should quiet hours be shared publicly?"
    answer: "No. Share only the role, exception and safe escalation detail needed by an authorised audience."
  - question: "Can FamilyBoard identify an emergency?"
    answer: "No. It cannot monitor people, detect danger or replace emergency services."
  - question: "What if the household routine changes?"
    answer: "Add a dated change, preserve the old boundary and tell the role responsible for the channel."
contentVersion: 1
---
