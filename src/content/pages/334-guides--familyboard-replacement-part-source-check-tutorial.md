---
title: "FamilyBoard Replacement Part Source Check Tutorial | Compatibility Evidence"
description: "Learn how to organise filters, bags, bulbs, batteries and other replacement parts in FamilyBoard using safe device references, source evidence, stock checks and separate purchase, arrival and use results."
route: "/guides/familyboard-replacement-part-source-check-tutorial/"
primaryIntent: "learn a FamilyBoard replacement-part source workflow that avoids guessing compatibility from a product title or appearance"
...
nextStep: "Choose one part often bought incorrectly, record its controlling source and create a task for the unresolved check."
related:
...
faq:
  - question: "What if I know only the product name?"
    answer: "Keep the row open and return to the rating plate, manual or service source; do not guess."
  - question: "Can arrival mark the part complete?"
    answer: "No. Ordering, arrival, visual similarity and suitability are separate events."
  - question: "Does the app decide whether a filter or bulb is safe?"
    answer: "No. Electrical, gas, water, height and other safety work belongs to qualified sources."
  - question: "Do I need affiliate products before a source record?"
    answer: "No. Confirm the device and source first; products are optional."
contentVersion: 1
---
