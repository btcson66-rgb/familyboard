---
title: "FamilyBoard Important Document Review Tutorial | Find Missing Household Sources"
description: "Learn how to use FamilyBoard's Important Household Document Review tool to review source locations, versions, owners and next checks without storing document text or account numbers."
route: "/guides/familyboard-important-household-document-review-tutorial/"
primaryIntent: "use the document review tool to find missing sources, stale versions and owned follow-up without copying document contents"
...
nextStep: "Review one document purpose, point to the exact protected source, assign every gap and ask another role to retrieve it before closing the review."
related: []
faq:
  - question: "Does the review store or read my documents?"
    answer: "No. It records safe source pointers and follow-up; it does not open your files."
  - question: "Can it decide which records I must keep?"
    answer: "No. Retention, tax, legal and provider rules come from the applicable source."
  - question: "Should I paste a lease, policy or account number?"
    answer: "No. Use a neutral document code and keep originals protected."
  - question: "Does a reviewed row prove a document is current?"
    answer: "No. It records that someone checked a source and what remains to confirm."
contentVersion: 1
---
