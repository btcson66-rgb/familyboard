---
title: "FamilyBoard Maintenance Event Cost Tutorial | Record Work and Evidence Separately"
description: "Learn how to record a FamilyBoard maintenance event, link it to an asset, preserve the observed cost and keep provider claims separate from household observations."
route: "/guides/familyboard-maintenance-event-cost-tutorial/"
primaryIntent: "record a completed maintenance event, observed cost and follow-up without treating an invoice as proof of quality or safety"
...
nextStep: "Link one maintenance event to the correct asset, record the observed result and cost source separately, and leave every unresolved follow-up open."
related: []
faq:
  - question: "Does a maintenance event prove the work was completed safely?"
    answer: "No. It records the household’s observed result and source pointers; qualified providers and official documents control safety and compliance."
  - question: "Should I record an estimated or paid amount as the same cost?"
    answer: "No. Keep quotes, approved scope, invoice and payment observations as separate facts with dates and sources."
  - question: "Can I attach a full invoice to a shared task?"
    answer: "Keep the original in its protected source and use a neutral pointer in FamilyBoard; share only the minimum needed."
  - question: "Does saving an event create a cloud backup?"
    answer: "No. It stays in the current browser until you deliberately export a backup."
contentVersion: 1
---
