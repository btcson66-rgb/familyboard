---
title: "Vacation Home Shutdown Checklist: What to Review Before You Leave"
description: "Create a household vacation shutdown routine for deliveries, pets, appliances, temperature, waste, service appointments and handoff contacts."
route: "/guides/vacation-home-shutdown-checklist/"
primaryIntent: "prepare the home before leaving for vacation"
...
nextStep: "Build the shutdown list from your own home's systems and trip length, then save it as a reusable travel template so the next departure starts from a checklist instead of memory."
related:
...
faq:
  - question: "What temperature should I set my thermostat to before leaving on a winter trip?"
    answer: "For a home that's unoccupied but still needs its systems protected, the Insurance Information Institute recommends a minimum of 65°F — lower settings don't reliably protect pipes since the space inside exterior walls runs colder than the room temperature reading. For an extended absence, professionally draining the water system is a stronger option than relying on heat alone."
  - question: "How far in advance can I schedule USPS mail hold before a trip?"
    answer: "Up to 30 days in advance, or as late as the next scheduled delivery day, through USPS Hold Mail. The service pauses delivery for a minimum of 3 and a maximum of 30 days, so it fits most vacation lengths but won't cover a longer absence on its own."
  - question: "Should I turn my water supply off completely before a trip?"
    answer: "For a short trip, shutting off individual appliance valves (washing machine, dishwasher, ice maker) is a reasonable middle ground. For an extended winter absence, professionally draining the water system is the stronger recommendation — check your specific systems and climate rather than applying one rule to every trip length."
  - question: "Is it safe to post about my vacation on social media while I'm away?"
    answer: "It's safer to hold off until you're back. Publicly broadcasting that a home is empty, even unintentionally through location tags or real-time photos, removes any uncertainty about whether the house is occupied — a small, easy habit to change with no real downside."
contentVersion: 1
---
