---
title: "FamilyBoard Export Scope Review Tutorial | Share Only What Is Needed"
description: "Learn how to inspect a FamilyBoard JSON or CSV export, remove unnecessary household details, label the copy and preserve the protected local source before sharing."
route: "/guides/familyboard-household-export-scope-review-tutorial/"
primaryIntent: "learn to review the minimum useful FamilyBoard export before a handoff, backup test or support request"
...
nextStep: "Export one untouched source, create a purpose-labeled derivative, inspect it as the recipient and record the copy's scope and review date."
related: []
faq:
  - question: "Does exporting create a safe share automatically?"
    answer: "No. An export is another copy and may contain more records than the recipient needs."
  - question: "Should I edit the only backup to make it smaller?"
    answer: "No. Preserve an untouched source export and create a separate derivative copy for review."
  - question: "Does CSV contain every FamilyBoard record?"
    answer: "No. Formats and fields differ; inspect the actual file and use JSON backup for a complete recovery path when appropriate."
  - question: "Can FamilyBoard send an export to another device for me?"
    answer: "No. The household controls where a file is saved, moved and deleted."
contentVersion: 1
---
