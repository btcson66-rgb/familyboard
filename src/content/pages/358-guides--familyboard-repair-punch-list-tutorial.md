---
title: "How to Build a Home Repair Punch List | FamilyBoard Tutorial"
description: "Build a reliable home repair punch list with observable items, scope references, recheck evidence and privacy-safe owner actions—without treating it as an inspection certificate."
route: "/guides/familyboard-repair-punch-list-tutorial/"
primaryIntent: "turn a home walkthrough into dated, observable repair items linked to scope, evidence, owners and rechecks"
...
nextStep: "Record one observable condition and its recheck evidence in the free Home Repair Punch List."
related:
...
faq:
  - question: "Does a punch list certify that work is safe or complete?"
    answer: "No. It records household observations and follow-up. A contract, inspector or qualified professional controls certification and acceptance."
  - question: "What belongs in a punch list instead of a change order?"
    answer: "An item belongs in the punch list when it is a visible condition within the agreed scope. New or changed work should be proposed in a separate change-order record."
  - question: "When can I close an item?"
    answer: "Only after the chosen dated recheck evidence is linked. A contractor's message saying “fixed” is a response, not automatically a household recheck."
  - question: "Are target dates legal or warranty deadlines?"
    answer: "No. They are household follow-up dates. Retrieve contractual, notice, payment, permit and warranty dates from their controlling sources."
contentVersion: 1
---
