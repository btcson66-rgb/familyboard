---
title: "FamilyBoard Emergency Tab Tutorial | Prepare Useful, Private Contact Information"
description: "Learn how to use FamilyBoard's Emergency tab for safe contact pointers, review sensitive flags and hand off only the minimum information needed in an urgent household situation."
route: "/guides/familyboard-emergency-information-privacy-tutorial/"
primaryIntent: "prepare a minimal emergency information view in FamilyBoard while keeping sensitive details in protected, authoritative sources"
primaryKeyword: "FamilyBoard emergency information tutorial"
cluster: "product"
pageType: "content"
indexable: false
depthVerified: true
...
nextStep: "Verify one outside contact through its authoritative source, store only a safe pointer, and test that the household can find the route without exposing a full private record."
related:
...
faq:
  - question: "Is the Emergency tab a replacement for calling emergency services?"
    answer: "No. It is a household reference. In an urgent situation, use the current local emergency service and responsible professional or authority instructions."
  - question: "Should I paste medical details or access codes into a contact note?"
    answer: "No. Keep diagnoses, medication instructions, full addresses, keys, passwords and private messages in an appropriate protected source."
  - question: "Does marking a contact sensitive hide it from everyone?"
    answer: "It helps the app exclude the record from certain summaries, but it is not a permission boundary. Anyone with the browser profile may still access local data."
  - question: "How often should emergency information be reviewed?"
    answer: "Review after a move, provider change, household-role change or failed contact test, and set a practical manual checkpoint. FamilyBoard does not send alerts while closed."
contentVersion: 1
---
