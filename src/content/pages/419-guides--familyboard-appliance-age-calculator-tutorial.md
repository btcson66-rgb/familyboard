---
title: "Appliance Age Calculator Tutorial | Use Purchase or Installation Dates Correctly"
description: "Learn how FamilyBoard calculates appliance age from a known purchase or installation date, how to handle uncertain dates, and how to save the result with service history."
route: "/guides/familyboard-appliance-age-calculator-tutorial/"
primaryIntent: "learn how to use the FamilyBoard appliance age calculator"
primaryKeyword: "appliance age calculator tutorial"
cluster: "tools"
pageType: "content"
indexable: false
depthVerified: true
...
faq:
  - question: "Can the appliance age calculator predict when a unit will fail?"
    answer: "No. It calculates elapsed calendar time only; it has no usage, maintenance, diagnostic or manufacturer-lifespan data."
  - question: "Can I decode a manufacture date from a serial number?"
    answer: "Do not assume so. Date-code schemes vary by manufacturer and model year, so use a known purchase or installation date instead."
  - question: "Should I enter purchase date or installation date?"
    answer: "Use the date that matches your purpose and the source. Warranty planning follows the warranty terms; wear planning often follows installation."
  - question: "What if the date is only an estimate?"
    answer: "Enter the best supported estimate, label it approximate in the appliance record, and do not treat the result as more precise than its input."
contentVersion: 1
---
