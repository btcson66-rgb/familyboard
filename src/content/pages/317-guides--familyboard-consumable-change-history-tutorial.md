---
title: "FamilyBoard Consumable Change History Tutorial | Filters, Dates and Review Notes"
description: "Learn how to record household filter and consumable changes in FamilyBoard with dates, source pointers, observed condition and follow-up checks. Do not treat the app as a fixed maintenance schedule or repair guide."
route: "/guides/familyboard-consumable-change-history-tutorial/"
primaryIntent: "learn a source-linked household filter and consumable history workflow without guessing a universal replacement interval or opening equipment unsafely"
primaryKeyword: "FamilyBoard filter replacement history tutorial"
cluster: "maintenance"
pageType: "content"
indexable: false
depthVerified: true
...
nextStep: "Record one change you can verify, then assign a follow-up that returns to the product label, manual or service source."
related:
...
faq:
  - question: "Does FamilyBoard tell me the correct replacement interval?"
    answer: "No. Use the current manufacturer guidance, label or qualified service source for an applicable interval; FamilyBoard records what your household checked."
  - question: "What if I only remember the month of a change?"
    answer: "Keep the date approximate and the row open until a protected receipt or service record can support a more precise observation. Do not invent a day."
  - question: "Can I open a device to inspect a filter?"
    answer: "Do not use this tutorial as disassembly guidance. Stop when electrical, refrigerant, gas, height or other hazards are involved."
  - question: "Should the old history be deleted after a new change?"
    answer: "No. Add a dated version so the household can see which source and condition belonged to each change."
contentVersion: 1
---
