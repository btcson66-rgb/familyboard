---
title: "Bathroom Exhaust Fan Maintenance Checklist: CFM Sizing and the Attic-Venting Mistake"
description: "A real bathroom exhaust fan checklist: HVI's CFM sizing rule, the 20-minute run time, cleaning interval, and why attic venting is a code violation, not a style choice."
route: "/guides/bathroom-exhaust-fan-maintenance-checklist/"
primaryIntent: "clean and monitor bathroom exhaust fans"
...
nextStep: "Confirm where your bathroom fan's duct actually terminates — outdoors, not the attic — and record your fan's rated CFM against HVI's sizing guide for the room."
related:
...
faq:
  - question: "How long should I run my bathroom exhaust fan after a shower?"
    answer: "About 20 minutes after use, per HVI, not just while the shower is running. Installing a timer switch is a simple way to make this happen automatically rather than relying on remembering to switch it off later."
  - question: "What size bathroom exhaust fan do I actually need?"
    answer: "HVI's baseline is 1 CFM per square foot of floor area for bathrooms up to 100 square feet — roughly eight air changes per hour. For larger bathrooms, size by fixture instead: a toilet, shower or standard tub each needs about 50 CFM, and a jetted tub needs about 100 CFM."
  - question: "Why does it matter whether my bathroom fan vents outside versus into the attic?"
    answer: "A fan venting into the attic still runs and still removes air from the bathroom, but it dumps moisture into an unconditioned space instead of outdoors, where it condenses on cold surfaces and creates conditions for mold and structural rot — often unnoticed for years. Building code has required exterior termination since roughly the mid-2000s, but many older installations still vent into the attic."
  - question: "My bathroom stays steamy long after I shower even though the fan runs — is it dirty or broken?"
    answer: "Possibly neither — it may simply be undersized for the room. Compare your fan's rated CFM against HVI's sizing guidance for your bathroom's square footage or fixture count before assuming the fan needs cleaning or replacement; an undersized fan can run perfectly and still not clear the room fast enough."
contentVersion: 1
---
