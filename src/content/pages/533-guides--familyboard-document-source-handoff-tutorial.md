---
title: "FamilyBoard Document Source Handoff | Preserve Provenance"
description: "Learn how to hand off a FamilyBoard document source safely, record provenance and version, limit disclosure and test whether the receiver can find the controlling record."
route: "/guides/familyboard-document-source-handoff-tutorial/"
primaryIntent: "hand off a document reference by preserving provenance, currentness, access limits and the receiver’s next action"
...
nextStep: "Give one receiver one document question, preserve the controlling source pointer and test whether the version and access limits are understood."
related: []
faq:
  - question: "Does a source pointer prove that a document is authentic?"
    answer: "No. It records where the household looked; the issuer or controlling system remains authoritative."
  - question: "Should the entire document be copied into a handoff?"
    answer: "No. Share the minimum pointer and context needed by the receiver."
  - question: "Is the newest file always the controlling version?"
    answer: "No. Check issuer, effective date, supersession language and the process that controls the record."
  - question: "What if the receiver cannot access the source?"
    answer: "Record the permission dependency and route it to the source owner; do not bypass the control."
contentVersion: 1
---
