---
title: "FamilyBoard Home-Care Visit Scope Tutorial | Record Service and Result Separately"
description: "Learn how to use FamilyBoard's Home-Care Visit Scope and Service Result Log to separate authorised tasks, provider notes, observed results and unresolved concerns without exposing medical details."
route: "/guides/familyboard-home-care-visit-scope-service-result-tutorial/"
primaryIntent: "learn to document a time-bounded home-care visit's authorised scope, source, observed service result and escalation question without replacing a care plan"
...
nextStep: "Record one visit's authorised scope, provider report and household observation as separate events, then leave any unresolved care question with its responsible escalation route."
related: []
faq:
  - question: "Does the log create or replace a care plan?"
    answer: "No. The responsible professional or authorised service plan controls care decisions."
  - question: "Should diagnoses, medication doses or full identities be entered?"
    answer: "No. Use the minimum safe reference and keep sensitive details in the protected care process."
  - question: "Does a completed visit prove that care was adequate?"
    answer: "No. It records a reported or observed result, not a clinical assessment."
  - question: "What if the agreed scope changes during a visit?"
    answer: "Preserve the original scope, record the change and identify who authorised the next step."
contentVersion: 1
---
