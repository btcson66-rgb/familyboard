---
title: "How to Use FamilyBoard's Date Offset Planner | Follow-Up Guide"
description: "Learn how to use FamilyBoard's date offset planner for maintenance reviews, handoffs and follow-ups without confusing a calculated date with an official deadline."
route: "/guides/familyboard-date-offset-planner-tutorial/"
primaryIntent: "teach households to turn a confirmed date and a day offset into an owned, source-checked follow-up"
...
related: []
faq:
  - question: "Should the offset be based on the day I entered the record or the day the work happened?"
    answer: "Use the date the controlling source actually defines, such as completion, receipt or notice date, and keep that source pointer beside the calculation."
  - question: "Does a seven-day offset create an automatic reminder?"
    answer: "No. It produces a planning date. Create a separate owned task or use the responsible calendar if the follow-up must trigger an alert."
  - question: "What if the source changes after I calculate?"
    answer: "Create a new dated calculation with a new review code. Keep the earlier result as an observation instead of silently overwriting history."
  - question: "Can I share the output with a contractor or school?"
    answer: "Share only the bounded purpose and the information that recipient needs. Keep addresses, access codes, account details and the original notice in the controlling system."
contentVersion: 1
---
