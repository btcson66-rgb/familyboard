---
title: "Home Contact List: The People and Services Your Household Actually Needs"
description: "Create a household contact list for family, neighbors, building management, utilities, schools, caregivers and service providers."
route: "/guides/home-contact-list/"
primaryIntent: "keep a concise list of household contacts"
...
nextStep: "Build a 15-contact household list organized by role, with a one-line reason for each entry, and flag anything sensitive so it stays out of printed or shared handoff sheets."
related:
...
faq:
  - question: "What's the difference between a home contact list and a household account list?"
    answer: "A contact list holds people and companies to call, organized by role, with a reason for each entry. An account list holds services the household has an account with — the provider, who owns the login, and what happens at a move. A utility company might appear on both, but for different reasons: the account list tracks ownership, the contact list tracks who to call right now."
  - question: "How many contacts should actually be on a household contact list?"
    answer: "Around fifteen curated entries is usually enough for another trusted adult to operate the home without digging through a personal phone's address book. The list is useful because it's a curated subset, not because it's exhaustive — a phone already holds hundreds of contacts nobody would actually need in a pinch."
  - question: "What does marking a contact \"sensitive\" actually do?"
    answer: "It excludes that contact from FamilyBoard's handoff export, which filters out any contact flagged sensitive before building a shareable snapshot. That means a contact whose notes include something private, like a health condition or custody detail, won't end up in a printed sheet or a summary handed to a sitter or caregiver."
  - question: "What should be written in the notes for each contact?"
    answer: "The reason they're on the list — \"neighbor, has spare key,\" \"after-hours vet line,\" \"pediatrician's office.\" A name and number alone forces whoever's reading the list in a hurry to guess why that person matters; the reason is often more useful than the number itself."
  - question: "How often should the contact list be reviewed for outdated entries?"
    answer: "At least as often as the household's monthly review. A contact list that goes unreviewed accumulates people who've moved, retired, or are no longer relevant — and discovering that in an actual emergency wastes exactly the time a curated list exists to save."
contentVersion: 1
---
