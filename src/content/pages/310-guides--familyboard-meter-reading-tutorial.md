---
title: "FamilyBoard Meter Reading Tutorial | Record Water, Electricity and Gas Observations Safely"
description: "Learn how to record a manual household meter observation in FamilyBoard for move-in, billing or maintenance handoff. Keep meter IDs and account details protected; do not treat the note as an official bill."
route: "/guides/familyboard-meter-reading-tutorial/"
primaryIntent: "learn to record a safe, manual household meter observation for move-in, billing review or maintenance handoff without making a billing or safety judgment"
primaryKeyword: "FamilyBoard meter reading tutorial"
cluster: "product"
pageType: "content"
indexable: false
depthVerified: true
...
nextStep: "Make one safe, manual observation from an accessible position, then verify that the next person can distinguish it from the provider's official billing record."
related:
...
faq:
  - question: "What is a meter reading row for?"
    answer: "It records what a household member safely observed, when they observed it and where the protected source lives. It is not an official utility reading or bill calculation."
  - question: "Does FamilyBoard subtract readings or calculate a charge?"
    answer: "No. Rates, billing periods, estimates and meter changes belong to the responsible provider and its statement."
  - question: "Can I open a locked meter box or move an appliance to take a photo?"
    answer: "No. Stop when the display cannot be read safely. Record the uncertainty and ask the provider or an appropriate professional."
  - question: "Should an installation or move-out reading overwrite the old one?"
    answer: "No. Use a new dated row so the household can distinguish move-in, service and later observations."
contentVersion: 1
---
