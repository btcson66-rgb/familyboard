---
title: "FamilyBoard Appliance Manual Tutorial | Match the Right Model and Source"
description: "Learn how to use FamilyBoard’s appliance manual source log to record model matching, official versions, safety limits and replacement-source follow-up."
route: "/guides/familyboard-appliance-manual-source-tutorial/"
primaryIntent: "verify the correct appliance manual source and model match before using instructions or sharing a handoff"
...
nextStep: "Match one appliance to its exact manual source, record the safety boundary and assign any model or version gap to a responsible role."
related: []
faq:
  - question: "Is a manual for the same brand safe to use for every model?"
    answer: "No. Match the exact model and revision; the manufacturer’s current source controls."
  - question: "Does a manual replace a technician or emergency instruction?"
    answer: "No. It provides product information, not a diagnosis, repair authorization or live safety decision."
  - question: "Should I upload a manual to a public handoff?"
    answer: "Keep the source protected and share the minimum model and pointer needed by the receiver."
  - question: "Does a source check prove the appliance is safe?"
    answer: "No. It verifies a document match, not the condition, installation or operation of the appliance."
contentVersion: 1
---
