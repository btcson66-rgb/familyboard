---
title: "FamilyBoard Caregiver Handoff Tutorial | Track Sources, Scope and Acceptance"
description: "Learn how to use FamilyBoard's Caregiver Handoff Source and Authorization Log to separate care sources, recipient authority, access, custody and acceptance while keeping sensitive instructions protected."
route: "/guides/familyboard-caregiver-handoff-source-authorization-tutorial/"
primaryIntent: "learn to document caregiver source, recipient authority, minimum scope, access and acceptance without granting permission or generating care instructions"
primaryKeyword: "FamilyBoard caregiver handoff authorization tutorial"
...
nextStep: "Define the recipient's minimum scope, point to the current protected source and record acceptance without turning the handoff into a permission grant."
related: []
faq:
  - question: "Does the log appoint a caregiver or create legal authority?"
    answer: "No. It records a source and observed process; the person, provider, agency and applicable authority process control permission."
  - question: "Should detailed routines, doses or transfer steps go in a shared row?"
    answer: "No. Keep care instructions and sensitive identity details in the responsible protected source."
  - question: "Does a caregiver briefing prove the person received safe care?"
    answer: "No. It records a briefing or acceptance observation, not care quality or a clinical result."
  - question: "Can the tool replace a discharge plan or agency instruction?"
    answer: "No. Use the current plan and qualified source for real care decisions and emergencies."
contentVersion: 1
---
