---
title: "FamilyBoard Home Dashboard Tutorial | Weekly Household Review"
description: "Use the FamilyBoard home dashboard for a focused weekly review: read the four counters, clear open responsibilities, inspect maintenance due soon and record what stays open."
route: "/guides/familyboard-home-dashboard-weekly-review-tutorial/"
primaryIntent: "run a repeatable weekly review from FamilyBoard's Today dashboard while understanding its counters and visibility limits"
...
nextStep: "Open Today, read each counter aloud, then assign one owner to every open row before the next weekly review."
related:
...
faq:
  - question: "What does the Today dashboard count?"
    answer: "It counts overdue tasks, maintenance due within seven days, active assets and active subscriptions from the current local household."
  - question: "Why are warranties not a dashboard counter?"
    answer: "Warranties and subscriptions have dedicated tabs. Create a task to review an important date if you want it to appear in the dashboard workflow."
  - question: "Does an empty dashboard mean the household has no work?"
    answer: "No. It means nothing is overdue or due within the dashboard's current window. Future items remain on their full tabs."
  - question: "Does the dashboard sync with another family member's phone?"
    answer: "No. Each browser profile has its own local database unless the household is manually transferred with a backup."
contentVersion: 1
---
