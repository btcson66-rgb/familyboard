---
title: "FamilyBoard Schedule Conflict Review Tutorial | Rescheduling and Family Handoffs"
description: "Use FamilyBoard to separate a household schedule conflict, source, constraint, role, proposal and confirmed result. Keep full school, work and service calendars in their protected systems."
route: "/guides/familyboard-schedule-conflict-review-tutorial/"
primaryIntent: "learn to review household schedule conflicts, constraints and rescheduling handoffs without copying private calendars"
primaryKeyword: "FamilyBoard schedule conflict tutorial"
cluster: "product"
pageType: "content"
indexable: false
depthVerified: true
...
nextStep: "Record one genuine collision between two household obligations, name the smallest constraint and assign one person to confirm the result at the controlling source."
related:
...
faq:
  - question: "Does FamilyBoard sync my Google, Outlook or school calendar?"
    answer: "No. Add only a minimal conflict summary and a safe source code. The original calendar, invitation or timetable stays in its own protected service."
  - question: "Can I paste the complete event invitation into the tool?"
    answer: "No. Keep names, addresses, meeting links, private messages and attendance details out of the shared row. Record only the boundary needed for the household decision."
  - question: "Is a proposed new time automatically confirmed?"
    answer: "No. A family proposal is not an accepted booking. Wait for the school, employer, service provider or calendar source to show the official result."
  - question: "What if two sources disagree?"
    answer: "Keep both source codes, leave the status open and assign a role to ask the responsible organization. Do not choose the more convenient time and mark it complete."
contentVersion: 1
---
