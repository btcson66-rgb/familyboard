---
title: "FamilyBoard Home Repair Cost Log Tutorial | Compare Scope Before Spending"
description: "Learn how to use FamilyBoard's Home Repair Cost Log to separate estimates, approved work, invoices and observed results without storing payment credentials or promising a contractor outcome."
route: "/guides/familyboard-home-repair-cost-log-tutorial/"
primaryIntent: "learn to record a household repair estimate, approved scope, payment observation and unresolved cost question without presenting a quote as a guarantee"
...
nextStep: "Record one repair proposal with scope, exclusions and the next question; keep approval, payment and observed result as separate dated events."
related: []
faq:
  - question: "Does the log tell me which contractor to hire?"
    answer: "No. It records the household's sources and decisions; selection and contract checks remain with the authorised person."
  - question: "Should card numbers or bank details be entered?"
    answer: "No. Keep payment credentials and complete financial records in the responsible protected system."
  - question: "Is an estimate the final price?"
    answer: "No. Preserve the estimate, approved scope, change and invoice as separate events."
  - question: "Does a lower number mean better value?"
    answer: "No. Scope, exclusions, source quality and observed result must be considered by the household."
contentVersion: 1
---
