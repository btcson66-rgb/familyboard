---
title: "Renovation Records | Scope, Changes, Punch List and Warranties"
description: "Build a renovation record that connects agreed scope, change orders, payments, dated observations, punch-list follow-up, products, warranties and tax evidence."
route: "/guides/renovation-records/"
primaryIntent: "organize a complete renovation record from agreed scope through changes, walkthrough and long-term ownership"
primaryKeyword: "renovation records organizer"
...
nextStep: "Preserve the current scope version first, then use the Home Repair Punch List for every visible item that still needs a written response, correction or dated recheck."
related:
...
faq:
  - question: "Is a household punch list the same as a formal inspection or legal acceptance?"
    answer: "No. It is a dated list of household observations and follow-up. A contract, authority, inspector or qualified professional may define a different inspection, completion or acceptance process. Preserve those source records separately."
  - question: "Should an item be closed when the contractor says it was corrected?"
    answer: "Not yet. Record the report, move the item to a recheck state and close it only after linking the dated evidence your household workflow requires. Closing still does not certify workmanship, code compliance, safety or legal acceptance."
  - question: "Does a permit prove the renovation was completed correctly?"
    answer: "A permit or inspection record supports only what the issuing authority actually recorded. Keep its date, status and scope without extending it into a general claim about workmanship, concealed work or every applicable requirement."
  - question: "Which renovation costs increase a U.S. home's tax basis?"
    answer: "IRS Publications 523 and 530 provide current rules and examples, but treatment depends on project scope, later removal, credits, subsidies, reimbursements and property use. Preserve project-level costs and source documents, then apply current tax guidance or professional advice rather than letting the archive decide."
  - question: "What should remain open at renovation close-out?"
    answer: "Any missing correction, recheck, permit or inspection result, final invoice explanation, warranty, manual, product reference or maintenance handoff should remain a named open item with an owner and date. Do not mark the package complete by assumption."
contentVersion: 2
---
...
Use the [Home Repair Change Order Log](/tools/home-repair-change-order-log/) to reconcile those versions without treating arithmetic as a contract amendment. Keep proposed, approved, declined and completed changes visible. Deleting declined proposals can make an early drawing or message impossible to explain later.
...
Do not close an item merely because someone reports it corrected. Move it to a recheck state, then preserve a dated observation showing what the household saw after the reported correction. The [Home Repair Punch List](/tools/home-repair-punch-list/) enforces that distinction. Its statuses organize evidence; they do not decide whether an item is a legal defect, whether the contract was substantially completed or whether work was accepted.

## Completion, acceptance, inspection and payment are separate decisions

The [Federal Trade Commission](https://consumer.ftc.gov/articles/how-avoid-home-improvement-scam) recommends detailed written contracts, written records of promises and payment tied to completed work. The [New York City home-improvement consumer guide](https://a860-gpp.nyc.gov/downloads/cr56n228m?locale=en) advises taking time to inspect the work, using the original project checklist and preserving copies of contracts, photos, warranties and payment evidence if a complaint is needed. California publishes its own [homeowner contract checklist](https://www.cslb.ca.gov/Consumers/Hire_A_Contractor/Home_Improvement_Contracts/Homeowner_Checklists.aspx).
