---
title: "FamilyBoard Household Return Handoff Tutorial | Returns, Dispatch and Refund Review"
description: "Learn how to organise a household return handoff with FamilyBoard: note the policy source, assign packing and dispatch roles, protect order details and review the actual refund or exchange result."
route: "/guides/familyboard-household-return-handoff-tutorial/"
primaryIntent: "learn a privacy-aware FamilyBoard workflow for returning online purchases, separating return eligibility, dispatch and refund observations"
...
nextStep: "Create one neutral return code, link the current policy source and assign packing, dispatch and refund-review roles."
related:
...
faq:
  - question: "Can FamilyBoard calculate a merchant’s return deadline or refund amount?"
    answer: "No. It records the household checkpoint; the merchant’s current policy and protected order source control the deadline and amount."
  - question: "Should an order number, address or payment token go in the shared row?"
    answer: "No. Use a neutral code and keep those details in the merchant or household’s controlled source."
  - question: "Does handing a parcel to a carrier prove that a refund is complete?"
    answer: "No. Dispatch, carrier acceptance and a confirmed refund or exchange are separate observations."
  - question: "Can packaging or label products guarantee a return will be accepted?"
    answer: "No. Any product suggestion is optional and cannot replace the merchant’s instructions."
contentVersion: 1
---
