---
title: "FamilyBoard Home Repair Change Order Tutorial | Track Scope and Approval Evidence"
description: "Learn how to use FamilyBoard's free repair change order log to compare original scope, new request, source approval and actual result without unsafe DIY or legal conclusions."
route: "/guides/familyboard-home-repair-change-order-tutorial/"
primaryIntent: "teach households to record repair scope changes, source approval and cost observations without approving work or giving construction advice"
...
nextStep: "Open Home Repair Change Order Log, copy the original scope into a protected pointer, then record one proposed change and its written approval source as pending or accepted by the responsible role."
related:
...
faq:
  - question: "Does logging a change order approve the extra work?"
    answer: "No. Approval must come from the responsible person or contract process."
  - question: "Does a paid invoice prove the repair is complete?"
    answer: "No. Payment, completion and later observation are separate facts."
  - question: "Can the tool tell me whether a repair is safe or legally required?"
    answer: "No. Use qualified professionals, current instructions and the responsible authority."
  - question: "Should I overwrite the original scope after a change?"
    answer: "No. Preserve the original and link a new change record so the decision trail stays reviewable."
contentVersion: 1
---
