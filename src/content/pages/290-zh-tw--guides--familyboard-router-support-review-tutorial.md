...
primaryIntent: "teach Taiwan households how to review router support and ISP responsibility without storing credentials or claiming network security"
...
nextStep: "用免費路由器支援複查工具建立來源地圖，再逐步完成型號、韌體、所有權與汰換決定的交接。"
related:
