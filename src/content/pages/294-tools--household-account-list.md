...
nextStep: "Start with two services that would be difficult to hand off, record only safe source indexes, and schedule a review before any transfer or cancellation."
related:
...
faq:
  - question: "Is this a password manager or login assistant?"
    answer: "No. It is a responsibility and source index. Keep passwords, passkeys, verification codes and recovery material in a dedicated protected service."
  - question: "What should a safe source index look like?"
    answer: "Use labels such as PROVIDER-P1, CONTRACT-C1 or HELP-H1 that point to a protected process or official document. Do not paste a login URL with personal identifiers, a full bill or a private message."
  - question: "Can the tool transfer or cancel a service?"
    answer: "No. It records the role, plan and review checkpoint. The current provider's official process controls identity checks, transfer rules, fees and cancellation results."
  - question: "Should I list every account in one permanent file?"
    answer: "Prefer a bounded review, such as move preparation or backup-role handoff. Keep only the services needed for that scope and create a new version when responsibility or policy changes."
  - question: "Can a future affiliate product be required to use this tool?"
    answer: "No. Any labelled product area must remain outside the form, be optional and never imply that buying storage or security equipment proves an account is safe."
contentVersion: 1
---
