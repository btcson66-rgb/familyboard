---
title: "Home Evacuation Information: Organize People, Pets, Contacts and Go-Bag Records"
description: "Organize household evacuation information around local official guidance, family roles, pet needs, contacts and essential records."
route: "/guides/home-evacuation-information/"
primaryIntent: "organize household information related to evacuation plans"
...
faq:
  - question: "How many days of supplies should a household evacuation go-bag hold?"
    answer: "Guidance varies by scenario: Maine's emergency management agency suggests planning for 3 to 7 days of supplies at home, but only 1 to 2 days in the go-bag itself if you're evacuating somewhere that already has food and water. The go-bag doesn't need to duplicate a full home supply — it needs to cover the gap until you reach one."
  - question: "What documents should be included in an evacuation go-bag?"
    answer: "City emergency-management guidance recommends copies (not necessarily originals) of insurance cards, photo IDs, birth certificates, deeds and proof of address, kept in a waterproof container along with a three-day medication supply. A household document index that already links family members to these records makes gathering copies fast instead of a last-minute search."
  - question: "Should evacuation plans specify the exact route to take?"
    answer: "No — the specific route, timing and shelter location should come from local authorities in the moment, based on the actual hazard. A household record's job is the logistics underneath that decision: who's responsible for what, what needs to come, and how the household reconnects, not route planning."
  - question: "How should a household stay in touch if evacuation separates family members?"
    answer: "Designating a single trusted out-of-area contact in advance is standard emergency-management guidance, since local phone lines are often congested during a real event while out-of-area calls or texts tend to go through. Every household member calling or texting the same designated person turns a chaotic search into a single point of coordination."
contentVersion: 1
---
