---
title: "FamilyBoard Language Preference Handoff | Make Household Instructions Understandable"
description: "Learn how to record FamilyBoard language preferences, translation limits and confirmation steps so a household handoff is understandable without exposing private details."
route: "/guides/familyboard-household-language-preference-handoff-tutorial/"
primaryIntent: "hand off a household task with the recipient’s language and accessibility preference while preserving the original meaning and source boundaries"
...
nextStep: "Record one recipient preference, preserve the controlling source and test whether the next action and stop condition were understood."
related: []
faq:
  - question: "Does a translated summary replace the controlling document?"
    answer: "No. It helps coordination; the issuer’s version and qualified interpreter remain authoritative."
  - question: "Should a language preference reveal a person’s full profile?"
    answer: "No. Record only the preference and task context needed by the authorised recipient."
  - question: "Can FamilyBoard certify a translation?"
    answer: "No. It can record what was used and what was confirmed, but cannot certify meaning."
  - question: "What if two people understand the instruction differently?"
    answer: "Preserve both observations, pause the risky action and route the question to the responsible source."
contentVersion: 1
---
