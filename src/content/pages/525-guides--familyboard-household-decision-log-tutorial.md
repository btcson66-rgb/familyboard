---
title: "FamilyBoard Household Decision Log | Make Decisions Traceable"
description: "Learn how to use FamilyBoard to record household decisions, separate facts from assumptions, assign owners and reopen a choice when the source changes."
route: "/guides/familyboard-household-decision-log-tutorial/"
primaryIntent: "record a household decision with its question, evidence, owner, review trigger and unresolved disagreement"
...
nextStep: "Log one household question, separate its evidence from preference and assign a named owner plus a trigger that can reopen it."
related: []
faq:
  - question: "Does a decision log make an opinion a verified fact?"
    answer: "No. Record the source and label assumptions, observations and open questions separately."
  - question: "Should every family member see every decision?"
    answer: "No. Match the handoff to the purpose and share only the minimum context needed by the role."
  - question: "What happens when people disagree?"
    answer: "Keep the disagreement visible, name the missing evidence or decision owner and set a review trigger."
  - question: "Is a decision entry a contract or legal advice?"
    answer: "No. Formal agreements, professional advice and authority remain in their controlling systems."
contentVersion: 1
---
