---
title: "FamilyBoard Replacement-Part Source Check Tutorial | Verify Before You Buy"
description: "Learn how to use FamilyBoard's Replacement-Part Source Check Log to record device-linked parts, model evidence, compatibility observations and protected storage."
route: "/guides/familyboard-replacement-part-source-check-log-tutorial/"
primaryIntent: "use a replacement-part source check log to connect a device, compatibility evidence, protected spare and open question without guaranteeing fit"
primaryKeyword: "replacement part compatibility checklist tutorial"
...
nextStep: "Start with one part your household has previously bought incorrectly, link it to neutral device evidence and leave unresolved fit questions visible."
related: []
faq:
  - question: "Does the log tell me which part to buy?"
    answer: "No. Confirm model, dimensions, ratings and written instructions in the controlling source."
  - question: "Is a retailer listing compatibility proof?"
    answer: "Not automatically. Keep manufacturer or responsible service evidence separate and dated."
  - question: "Should I enter a serial number or receipt?"
    answer: "No. Use a neutral asset code and protected source pointer."
  - question: "Does “received” mean the part is safe to install?"
    answer: "No. Receipt, fit and installation safety are separate observations."
contentVersion: 1
---
