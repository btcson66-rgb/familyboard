---
title: "Appliance Replacement Planner Tutorial | Read Monitor and Review Without Guessing"
description: "Learn how FamilyBoard's appliance replacement planner uses your own horizon and condition input, what Monitor and Review mean, and what evidence to collect next."
route: "/guides/familyboard-appliance-replacement-planner-tutorial/"
primaryIntent: "learn how to use the appliance replacement planner without treating it as a failure prediction"
primaryKeyword: "appliance replacement planner tutorial"
cluster: "tools"
pageType: "content"
indexable: false
depthVerified: true
...
faq:
  - question: "What is the difference between Monitor and Review?"
    answer: "Monitor means normal condition and more than two years remain in your chosen horizon; Review means inspect the situation now, not that the appliance has failed."
  - question: "Does a large repair estimate automatically create Review?"
    answer: "No. The estimate is carried for reference; the flag uses reported condition and remaining horizon."
  - question: "Is the planning horizon a manufacturer lifespan?"
    answer: "No. It is your household's own planning window and has no built-in brand-life data."
  - question: "What should I do when a normal appliance receives Review?"
    answer: "Verify the dates and inputs, gather history and dimensions, and obtain a real quote if replacement is being considered."
contentVersion: 1
---
