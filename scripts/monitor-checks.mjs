...
export const checks = [
  ...
  // The sitemap is split per locale and section by scripts/split-sitemap.mjs so
  // Search Console reports coverage per section instead of one opaque total. Each
  // segment is monitored separately; a segment that stops being served is a
  // discovery outage for everything inside it. The forbidden URLs are repeated on
  // every segment because "must not be in the sitemap" now means "in none of them".
  {
    path: "/sitemap-en-core.xml",
    require: [
  ...
  },
  {
    ...
    require: [
      ...
      "<loc>https://familyboard.win/guides/familyboard-important-household-document-review-tutorial/</loc>",
      "<loc>https://familyboard.win/guides/familyboard-appliance-maintenance-checklist-generator-tutorial/</loc>",
  ...
  {
    path: "/sitemap-en-printables.xml",
    require: [
  ...
  },
  {
    ...
    require: [
      ...
      "<loc>https://familyboard.win/tools/receipt-retention-organizer/</loc>",
      ...
      "<loc>https://familyboard.win/tools/appliance-maintenance-checklist-generator/</loc>",
  ...
  {
    path: "/sitemap-zh-tw-features.xml",
    require: [
  ...
  },
  {
    ...
    require: [
      ...
      "<loc>https://familyboard.win/zh-tw/guides/familyboard-important-household-document-review-tutorial/</loc>",
  ...
  {
    path: "/sitemap-zh-tw-printables.xml",
    require: [
  ...
  {
    path: "/guides/familyboard-important-household-document-review-tutorial/",
    require: ["Important Household Document Review", "exact source version"],
  },
  {
    path: "/zh-tw/guides/familyboard-important-household-document-review-tutorial/",
    require: ["重要家庭文件複查教學", "來源版本", 'lang="zh-TW"'],
  },
  {
    path: "/guides/familyboard-appliance-maintenance-checklist-generator-tutorial/",
    require: ["Appliance Maintenance Checklist Generator", "actual model manual"],
  },
  {
    path: "/zh-tw/guides/familyboard-appliance-maintenance-checklist-generator-tutorial/",
    require: ["家電保養檢查表產生器教學", "實際型號手冊", 'lang="zh-TW"'],
  },
  {
    path: "/guides/familyboard-receipt-retention-organizer-tutorial/",
    require: ["Receipt Retention Organizer", "protected evidence"],
  },
  {
  ...
  },
  {
    ...
    require: [
      "How to use a warranty expiration calculator as a planning aid",
  ...
  },
  {
    ...
    require: [
      ...
      "is not the same as a confirmed end",
    ],
  },
  {
  ...
  },
  {
    ...
    require: [
      ...
      "without creating another risky contact list",
    ],
  },
  {
  ...
  },
  {
    ...
    require: [
      ...
      "decide whether driving is permitted",
    ],
  },
  {
  ...
  },
  {
    ...
    require: [
      ...
      "does not authorise a payment, medical decision, legal signature or physical action",
    ],
  },
  {
  ...
  },
  {
    ...
    require: [
      ...
      "does not turn the device into a security kiosk, a calendar synchronizer or a remote control centre",
    ],
  },
  {
  ...
  },
  {
    ...
    require: [
      ...
      'hreflang="zh-TW"',
      "does not open a claim or predict an outcome",
    ],
  },
  {
  ...
  },
  {
    ...
    require: [
      ...
      'hreflang="zh-TW"',
      "does not send messages, grant entry, verify consent, calculate a legal deadline, interpret a lease",
    ],
  },
  {
  ...
  },
  {
    ...
    require: [
      ...
      'hreflang="zh-TW"',
      "does not contact a landlord, calculate a legal deadline, interpret a lease, determine responsibility",
    ],
  },
  {
  ...
  },
  {
    ...
    require: [
      ...
      'hreflang="zh-TW"',
      "does not access school systems, send notices, verify enrollment, decide attendance",
    ],
  },
  {
  ...
  },
  {
    ...
    require: [
      ...
      'hreflang="zh-TW"',
      "does not prove authenticity by itself",
    ],
  },
  {
  ...
  },
  {
    ...
    require: [
      ...
      "does not read or upload household records",
    ],
  },
  {
  ...
  {
    path: "/tools/household-task-load-calculator/",
    require: [
      "Household Task Load Calculator",
      "approximate weekly total",
      "make recurring work visible",
    ],
  },
  {
    path: "/zh-tw/tools/household-task-load-calculator/",
    require: [
      "家庭家務負荷計算器",
      "每週時間",
      'lang="zh-TW"',
